    ...
    <html>
        ...
        <body>
            ...
            <div class="container panel panel-default">
                        ...
                        <form action="./activityCreate" method="post" class="form-horizontal">
                            ...
                            <div class="col-md-10">
                                ...
                                <div class="form-group">
                                    ...
                                    <a href="./deleteCounter"><input class="btn btn-danger pull-right" value="Delete Activity Tracker"></a>
                                </div>
                            </div>
                        </form>
                ...
                <p><br></p>
                <center><h2>Available Activities</h2></center>
                <p><br></p>
                ...
                <p><br></p>
                <center><h2>Unavailable Activities</h2></center>
                <p><br></p>
