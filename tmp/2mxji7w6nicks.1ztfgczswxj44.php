            ...
            <nav class="navbar navbar-default" id="nav">
                <div class="container-fluid">
                    ...
                    <ul class="nav navbar-nav">
                        <li ><a href="/CampSambica">Home</a></li>
                        <li class="active"><a href="/CampSambica/information_form">New Camper</a></li>
                        <li><a href="/CampSambica/activities">Edit Activities</a></li>
                        <li><a href="/CampSambica/displaymembers">View Members</a></li>
                        <li><a href="/CampSambica/logout">Logout</a></li>
